...
docker images |grep rabbitmq |awk '{ imageName=$1":"$2; print imageName}' | xargs docker run -d -it -p 5672:5672 -p 15672:15672 --name rabbitLearn --hostname rabbitCluster01
